...
public class ExtentReportManager {
	...
	public static ExtentReports getReportInstance(){
		...
		if(report == null){
			...
			ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "\\reports\\extent-report\\" + reportName);
			report =  new ExtentReports();
			report.attachReporter(htmlReporter);
			//system information for the extent-report
